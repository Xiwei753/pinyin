...
- `tools/dictionary/build_t9_assets.py` generates `t9_source_dict.tsv` and `t9_dict.db`.

## Generated Dictionary Assets

- `t9_source_dict.tsv` and `t9_dict.db` are BUILD ARTIFACTS, not hand-maintained source files.
- They are generated by Gradle task `generateT9DictionaryAssets` at build time.
- Do NOT manually edit or commit `app/src/main/assets/t9_source_dict.tsv` or `t9_dict.db`.
- Output goes to `app/build/generated/t9Assets/` and is automatically included in APK assets.
- To regenerate after modifying dictionary sources, run `./gradlew generateT9DictionaryAssets` or just `./gradlew test assembleDebug`.
- Source files that trigger regeneration:
  - `third_party/rime-ice/cn_dicts/base.dict.yaml`
  - `third_party/rime-ice/cn_dicts/8105.dict.yaml`
  - `tools/dictionary/android_common_phrases.tsv`
  - `tools/dictionary/pinyin_corrections.tsv`
